...
//Taking that array and checking if it is prime and creating a new array [2,3,5]
const primeArray = originalArray.filter(isPrime);
console.log(primeArray);


// TODO: Describe how filter is working in this example. What will the value of moreThan5Array be? 
// [10] Checks to see if array has a number greater than 5 and sets it to true so it will pass the number through
